function generateNavigationBar() {
    ...
    navBar += '<a href="#" class="dropdown-toggle" data-toggle="dropdown">Portfolio <b class="caret"></b></a>';
    navBar += '<ul class="dropdown-menu">';
    navBar += '<li>';
    navBar += '<a href="portfolio-1-col.html">1 Column Portfolio</a>';
    navBar += '</li>';
    navBar += '<li>';
    navBar += '<a href="portfolio-2-col.html">2 Column Portfolio</a>';
    navBar += '</li>';
    navBar += '<li>';
    navBar += '<a href="portfolio-3-col.html">3 Column Portfolio</a>';
    navBar += '</li>';
    navBar += '<li>';
    navBar += '<a href="portfolio-4-col.html">4 Column Portfolio</a>';
    navBar += '</li>';
    navBar += '<li>';
    navBar += '<a href="portfolio-item.html">Single Portfolio Item</a>';
    navBar += '</li>';
    navBar += '</ul>';
    navBar += '</li>';
    navBar += '<li class="dropdown">';
